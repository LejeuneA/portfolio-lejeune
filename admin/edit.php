...
<body>
    ...
    <header id="header">
        <!-- Profile -->
        <div class="profile">
            <img src="../assets/images/header-photo.jpg" alt="Açelya Lejeune profile photo" class="profile-img">
        ...
        <nav id="navbar" class="nav-menu navbar">
            <ul>
                <li>
                    <a href="../index.php#hero" class="nav-link scrollto active">
                ...
                <li>
                    <a href="portfolio.php" class="nav-link scrollto">
                ...
                <li>
                    <a href="add.php" class="nav-link scrollto">
                ...
                <li>
                    <a href="messages.php" class="nav-link scrollto">
    ...
    <main id="main" class="admin-edit">
        ...
        <section class="section-edit">
            <form method="POST" action="edit.php?id=<?= htmlspecialchars($record['id']) ?>">

                <label for="display_id">ID</label>
                <input type="text" id="display_id" value="<?= htmlspecialchars($record['id']) ?>" readonly>

                <input type="hidden" name="id" value="<?= htmlspecialchars($record['id']) ?>">

                <label for="image_url">Image URL:</label>
                <input type="text" id="image_url" name="image_url"
                    value="<?= htmlspecialchars($record['image_url']) ?>">

                <label for="info_url">Info URL:</label>
                <input type="text" id="info_url" name="info_url"
                    value="<?= htmlspecialchars($record['info_url']) ?>">

                <label for="info_url_fr">Info URL FR:</label>
                <input type="text" id="info_url_fr" name="info_url_fr"
                    value="<?= htmlspecialchars($record['info_url_fr']) ?>">

                <label for="live_url">Live URL:</label>
                <input type="text" id="live_url" name="live_url"
                    value="<?= htmlspecialchars($record['live_url']) ?>">

                <label for="github_url">GitHub URL:</label>
                <input type="text" id="github_url" name="github_url"
                    value="<?= htmlspecialchars($record['github_url']) ?>">
